...
- Pathfinding / Graph Searching
  - [Depth First Search](https://en.wikipedia.org/wiki/Depth-first_search), [Breadth First Search](https://en.wikipedia.org/wiki/Breadth-first_search) (basic graph traversal algorithms)
